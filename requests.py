...
# Replace with your actual access token and LinkedIn Page (organization) ID
org_id = "12345678"  # Replace with your actual org ID from LinkedIn
...
url = (
    "https://api.linkedin.com/v2/dmaPagePosts"
    f"?q=organizationalEntity&organizationalEntity={org_urn}&viewContext=ADMIN"
)

response = requests.get("https://api.linkedin.com/rest/dmaPosts", headers=headers)
